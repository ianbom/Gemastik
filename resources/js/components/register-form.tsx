                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="font-bold text-green-700 text-balance">
                                    Daftar untuk akun KawanBumi anda
                                </p>
                            </div>
                            ...
                            <Button
                                type="submit"
                                className="w-full text-white bg-green-800 hover:bg-green-700 disabled:opacity-50"
                                disabled={processing}
                            >
                                {processing
                                    ? 'Membuat akun...'
