...
@section('content')
    <div class="p-4 mx-auto max-w-7xl">
        ...
        <div class="mb-4">
            <h1 class="mb-2 text-3xl font-bold text-gray-900">Edit Badge</h1>
            <p class="text-gray-600">Perbarui informasi badge</p>
        </div>
        <div class="overflow-hidden bg-white rounded-lg shadow-lg">
            ...
            <form action="{{ route('admin.badges.update', $badge->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $badge->title) }}"
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" rows="4"
                        ...
                        placeholder="Masukkan deskripsi badge (opsional)">{{ old('description', $badge->description) }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    @if ($badge->icon_url)
                        <div class="mb-4">
                            ...
                            <div class="flex items-center space-x-4">
                                <img src="{{ asset('storage/' . $badge->icon_url) }}" alt="Current Badge Icon"
                ...
                <div class="flex items-center justify-end pt-6 space-x-4 border-t border-gray-200">
                    ...
                    <button type="submit"
                        class="px-6 py-3 text-white transition-colors bg-green-500 rounded-lg hover:bg-green-600">
                        Update Badge
                    </button>
                </div>
            </form>
