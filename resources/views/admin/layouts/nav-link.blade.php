<nav class="flex flex-col flex-1">
    <ul role="list" class="flex flex-col flex-1 gap-y-7">
        <li>
            <div class="font-semibold text-xs/6 text-emerald-200">Dashboard</div>
            <ul role="list" class="mt-2 -mx-2 space-y-1">
                <li>
                    {{-- Dashboard --}}
                    <a href="{{ route('admin.dashboard.index') }}"
                        class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold {{ request()->routeIs('admin.dashboard.*') ? 'bg-emerald-800 text-white' : 'text-emerald-100 hover:text-white hover:bg-emerald-800' }}">
                        <svg class="size-6 shrink-0 {{ request()->routeIs('admin.dashboard.*') ? 'text-white' : 'text-emerald-300 group-hover:text-white' }}"
        ...
        <li>
            <div class="font-semibold text-xs/6 text-emerald-200">Laporan dan Misi</div>
            <ul role="list" class="mt-2 -mx-2 space-y-1">
                <li>
                    {{-- Reports --}}
        ...
        <li>
            <div class="font-semibold text-xs/6 text-emerald-200">Manajemen Pengguna</div>
            <ul role="list" class="mt-2 -mx-2 space-y-1">
                <li>
                    {{-- Users --}}
